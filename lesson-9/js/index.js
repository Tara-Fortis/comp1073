...
// Coffee is a captial, because it is a constructor
function Coffee(size, isDecaf, qtyCream, qtySugar) {
    this.size = size;
    // this.isDecaf = isDecaf;
    this.decaf = (this.isDecaf === true ? "decaffinated" : "caffineated");
    this.qtyCream = qtyCream;
    this.qtySugar = qtySugar;
    this.description = function () {
        output.textContent = `A ${this.size} ${this.isDecaf} coffee with ${qtyCream} creamers and ${this.qtySugar} teaspons of sugar.`;
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let scottsCoffee = new Coffee("exra-large", false, 2, 1);
