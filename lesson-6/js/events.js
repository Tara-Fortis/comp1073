...
/* STEP 3: Let's apply event handlers/listeners to a group of buttons - comment out the BUTTON element, and create three new ones, A, B, and C */
// const buttons = document.querySelectorAll("button"); // creates an arry of all objects
// console.log(buttons);

// for (let i = 0; i < buttons.length; i++) {
//     buttons[i].onclick = bgChange;
//     // buttons[i].onclick = bgChange; old code
// }
