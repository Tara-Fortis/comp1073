...
// STEP 1b: Any value that is not false, undefined, null, 0, NaN, or an empty string will evaluate to TRUE when tested using a conditional statement - try a few other values for let homeWorkDone and test
...
function setWeather() {
	...
	} else (icon.setAttribute ("src", "images/cloud-off"));
