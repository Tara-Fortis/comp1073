...
for (let i = 0; i < myArray.length; i ++) {
        //Check if array element is an arry
...
let orig6 = `Toronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montreal Candiens, New York Rangers`;
...
let orig6Length = orig6Array.push("Buffalo Sabres", "Philadelpia Flyers");
